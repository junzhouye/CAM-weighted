"""
https://github.com/jiweibo/ImageNet/blob/master/models/resnet.py
get final conv_feature_map :(BatchSize, Channel,7,7) channel is 512 or 2048
input shape (BatchSize, 3, 244, 244)
"""
...
def resnet18(pretrained=False, get_feature=False, **kwargs):
...
def resnet34(pretrained=False, get_feature=False, **kwargs):
...
def resnet50(pretrained=False, get_feature=False, **kwargs):
...
def resnet101(pretrained=False, get_feature=False, **kwargs):
...
def resnet152(pretrained=False, get_feature=False, **kwargs):
...
if __name__ == "__main__":
    ...
    model = resnet101()
    feature, outputs = model(inputs,True)
    print(feature.size())
    print(outputs.size())
