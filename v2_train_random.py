...
OK
"""
from trainers2.random_train import *
...
for epoch in range(1, args.epochs + 1):
    ...
    random_per_train_epoch(model, device, train_loader, optimizer, epoch,epsilon=0.031)
    ...
    if (epoch % args.save_freq == 0) or (epoch == args.epochs):
        torch.save(model.state_dict(),
                   os.path.join(model_dir, 'v2_random_model_epoch{}.pth'.format(epoch)))
