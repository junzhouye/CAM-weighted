...
mode 13
"""
from trainers2.trade_train import *
...
for epoch in range(1, args.epochs + 1):
    ...
    cam_weighted_trade_train_epoch(model, device, train_loader, optimizer, epoch, step_size, epsilon, perturb_steps, beta,mode=mode)
    ...
    if (epoch % args.save_freq == 0) or (epoch==args.epochs):
        torch.save(model.state_dict(),
                   os.path.join(model_dir, 'v2_cam_trade_beta_{}_mode{}_epoch{}.pth'.format(beta, mode,epoch)))
