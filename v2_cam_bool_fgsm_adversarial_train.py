...
for epoch in range(1, args.epochs + 1):
    ...
    cam_weight_fgsm_adversarial_train_epoch(model, device, train_loader, optimizer, epoch, epsilon, alpha,
    ...
    if (epoch % args.save_freq == 0) or (epoch == args.epochs):
        torch.save(model.state_dict(),
                   os.path.join(model_dir, 'v2_cam_fgsm_bool_adversarial_mode{}_epoch{}.pth'.format(mode, epoch)))
