...
def vgg11(pretrained=False, get_feature=False, **kwargs):
...
def vgg11_bn(pretrained=False, get_feature=False, **kwargs):
...
def vgg13(pretrained=False, get_feature=False, **kwargs):
...
def vgg13_bn(pretrained=False, get_feature=False, **kwargs):
...
def vgg16(pretrained=False, get_feature=False, **kwargs):
...
def vgg16_bn(pretrained=False, get_feature=False, **kwargs):
...
def vgg19(pretrained=False, get_feature=False, **kwargs):
...
def vgg19_bn(pretrained=False, get_feature=False, **kwargs):
...
if __name__ == "__main__":
    inputs = torch.randn((3, 3, 244, 244))
    model = vgg16()
    feature, outputs = model(inputs, get_feature=True)
    print(feature.size())
    print(outputs.size())
